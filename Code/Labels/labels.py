...
words_dict : dict[str,set[str]] = {
    ...
    'MEN'                          : set(['manly', 'man', 'unmanned', 'manhood', 'man', 'Tarquin (man)']),
    ...
    'VIOLENCE'                     : set(['strokes', 'murder', 'smother’d', 'smother', 'murder', 'murderers', 'strangles', 'violent', 'quarrel', 'quarrels', 'murderous', 'contending', 'fight', 'fighting', 'hack’d', 'beat', 'stick', 'revenge', \
                                          ...
                                          'executioners', 'executioner', 'cleft', 'knock', 'bruised', 'trample', 'flaying', 'kill', 'blisters', 'ript up', 'enterprise [violent plan]', 'mangled', 'massacre', 'make [his passage] through', \
                                          ...
                                          'harms', '[runs through]', 'left', '[tear to pieces]', 'lift [a hand] against', 'monomachie', 'pierce', 'deed [murder]', 'brus’d', 'wadge', 'exploits [murders]', 'stretch', '[drawn in pieces]', \
    ...
    'WOMEN'                        : set(['woman', 'womans', 'dames', 'matrons', 'womanly', 'girl', 'shee', 'she', 'wench', 'wenches', 'wives', 'thence [the woman]', 'mistris', 'Tullia [woman]', 'Nelly [woman]', 'sex', 'her', 'weomen', 'thou [woman]'])
}
